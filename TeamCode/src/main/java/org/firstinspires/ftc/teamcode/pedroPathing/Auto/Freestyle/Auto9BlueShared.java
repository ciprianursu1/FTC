...
import org.firstinspires.ftc.teamcode.pedroPathing.Paths.BlueShared;

@Autonomous(name = "Auto9BlueShared", group = "AutoTimisoara")
public class Auto9BlueShared extends FreestyleAutoBase {
    private BlueShared paths;
    ...
    protected Pose getStartPose() {
        return new Pose(60.0, 28.0, Math.toRadians(127.0));
    }

    @Override
    protected void initPaths() {
        paths = new BlueShared(follower);
    }
